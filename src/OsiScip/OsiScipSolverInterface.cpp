...
#include "OsiCuts.hpp"
#include "OsiScipSolverInterface.hpp"
...
CoinWarmStart* OsiScipSolverInterface::getEmptyWarmStart() const {
	throw CoinError("Not supported.", "getEmptyWarmStart", "OsiScipSolverInterface");
	return NULL;
}

CoinWarmStart* OsiScipSolverInterface::getWarmStart() const {
	throw CoinError("Not supported.", "getWarmStart", "OsiScipSolverInterface");
	return NULL;
}

bool OsiScipSolverInterface::setWarmStart(const CoinWarmStart* warmstart) {
	throw CoinError("Not supported.", "setWarmStart", "OsiScipSolverInterface");
	return false;
}
...
std::vector<double*> OsiScipSolverInterface::getDualRays(
		...
		bool fullRay) const {
	/** TODO: Implement */
	throw CoinError("Not implemented.", "getDualRays", "OsiScipSolverInterface");
	return std::vector<double*>();
}

std::vector<double*> OsiScipSolverInterface::getPrimalRays(int maxNumRays) const {
	/** TODO: Implement */
	throw CoinError("Not implemented.", "getPrimalRays", "OsiScipSolverInterface");
	return std::vector<double*>();
}
...
void OsiScipSolverInterface::loadProblem(const CoinPackedMatrix& matrix,
	...
	/** create problem */
	SCIP_CALL_ABORT(SCIPcreateProbBasic(scip_, "Osi"));
