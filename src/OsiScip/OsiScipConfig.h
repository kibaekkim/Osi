...
#ifndef __OSISCIPCONFIG_H__
#define __OSISCIPCONFIG_H__

#ifdef HAVE_CONFIG_H
#ifdef OSISCIPLIB_BUILD

#ifdef DLL_EXPORT
# define OSISCIPLIB_EXPORT __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
# define OSISCIPLIB_EXPORT __attribute__((__visibility__("default")))
#else
# define OSISCIPLIB_EXPORT
#endif

#else
#include "config_osiscip.h"
#endif

#else /* HAVE_CONFIG_H */


#ifndef OSISCIPLIB_EXPORT
# if defined(_WIN32) && defined(DLL_EXPORT)
#  ifdef OSISCIPLIB_BUILD
#   define OSISCIPLIB_EXPORT __declspec(dllexport)
#  else
#   define OSISCIPLIB_EXPORT __declspec(dllimport)
#  endif
# elif defined(__GNUC__) && __GNUC__ >= 4
#  define OSISCIPLIB_EXPORT __attribute__((__visibility__("default")))
# else
